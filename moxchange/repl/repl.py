...
def print_banner(version: str, port: int) -> None:
    ascii_art = "                      __                        \n  __ _  ___ __ ______/ /  ___ ____  ___ ____    \n /  ' \\/ _ \\\\ \" / __/ _ \\/ _ `/ _ \\/ _ `/ -_)   \n/_/_/_/\\___/_\\_\\\\__/_//_/\\_,_/_//_/\\_, /\\__/    \n                                  /___/         \n"
    console.print(ascii_art, style="cyan")
    console.print(f"Version: [cyan]{version}[/cyan] | Created by [cyan]februu[/cyan]")
    ...
    console.print(f"⚡ Connect your client here: [green]127.0.0.1:{port}/ws[/green]\n")
